...
public class FooterPage:BaseEntity
{
    ...
    public string SeoWhyParsImage { get; set; } = string.Empty;
    ...
    public string SeoParsDarYekImage { get; set; } = string.Empty;

    //اهداف
    public string ParsGoalsDesc { get; set; } = string.Empty;
    public string ParsGoalsImage { get; set; } = string.Empty;
    ...
    public string ParsInstallmentPurchaseImage { get; set; } = string.Empty;
    ...
    public string ParsBuyingGuideImage{ get; set; } = string.Empty;
    ...
    public string ParsOrganizationalPurchaseImage { get; set; } = string.Empty;
    ...
    public string ParsWarrantyDescImage { get; set; } = string.Empty;
    ...
    public string ParsShippingMethodsDescImage { get; set; } = string.Empty;
    ...
    public string ParsConsultationBeforePurchaseDescImage { get; set; } = string.Empty;
    ...
    public string ParsProceduresForReturningGoodsDescImage { get; set; } = string.Empty;
    ...
    public string ParsTrackingOrdersDescImage { get; set; } = string.Empty;
    ...
    public string ParsOnlineSupportDescImage { get; set; } = string.Empty;
    ...
    public string ParsRegulationsDescImage { get; set; } = string.Empty;
    ...
    public string ParsUserPrivacyDescImage { get; set; } = string.Empty;

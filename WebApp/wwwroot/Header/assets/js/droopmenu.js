!function (e) {
    ...
    e.fn.droopmenu = function (o) {
        ...
        o = e.extend(d, o);
        var a = e(this), n = e("body"), t = e(a), s = e(".droopmenu-nav"), i = e(".droopmenu-toggle"),
            r = e('<div class="dm-arrow"></div>'), m = e('<div class="droopmenu-overlay"></div>'),
            ...
            p = m, c = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
            f = function () {
                ...
                o.preventDefault();
                var a = e(this), n = a.closest("ul:not(.droopmenu-grid ul)"), t = n.find(".dmtoggle-open"),
                    s = a.closest("li"), i = s.hasClass("dmtoggle-open"), r = 0;
        ...
        return this.each(function () {
            ...
            e(a).find(".droopmenu-tabs").each(function (o) {
                var d = e(this);
                d.wrapInner('<div class="droopmenu-tabpanel droopmenutabcol"></div>'), d.prepend('<div class="droopmenu-tabnav droopmenutabcol"></div>'), d.find(".encrypt111212132").each(function (a) {
                    e(this).attr("id", "droopmenutab" + o + a), e(this).children(".droopmenu-tabencrypt231432").attr("href", "#droopmenutab" + o + a), d.children(".droopmenu-tabnav").append('<a href="#droopmenutab' + o + a + '">' + e(this).children(".droopmenu-tabencrypt231432").html() + "</a>")
                }), d.find(".encrypt111212132:first").addClass("droopmenu-tab-active"), d.find(".droopmenu-tabnav a:first").addClass("droopmenu-tab-active"), d.find(".droopmenu-tabencrypt231432").each(function (o) {
                    e(this).on("click", function (o) {
                        o.preventDefault(), d.find(".encrypt111212132").closest().removeClass("droopmenu-tab-active");
                        var a = e(this).parent().index();
                        e(this).hasClass("droopmenu-tab-active") ? d.find(".encrypt111212132 > .droopmenu-tab-active").removeClass("droopmenu-tab-active") : (d.find(".encrypt111212132 > .droopmenu-tab-active").removeClass("droopmenu-tab-active"), d.find(".encrypt111212132:eq(" + a + ")").children().toggleClass("droopmenu-tab-active"))
                    })
                }), d.find(".droopmenu-tabnav a").each(function (o) {
                    e(this).closest(d).hasClass("droopmenu-tab-hover") ? e(this).hover(function () {
                        var o = e(this).index();
                        d.find(".encrypt111212132, .droopmenu-tabnav a").removeClass("droopmenu-tab-active"), d.find(".encrypt111212132:eq(" + o + "), .droopmenu-tabnav a:eq(" + o + ")").toggleClass("droopmenu-tab-active")
                    }) : e(this).on("click", function (o) {
                        o.preventDefault();
                        var a = e(this).index();
                        d.find(".encrypt111212132, .droopmenu-tabnav a").removeClass("droopmenu-tab-active"), d.find(".encrypt111212132:eq(" + a + "), .droopmenu-tabnav a:eq(" + a + ")").toggleClass("droopmenu-tab-active")
                    })
                })
            }), function () {
                if (e(a).find(".droopmenu li a").each(function () {
                    e(this).siblings("ul").length > 0 && (e(this).attr("aria-expanded", "false"), e(this).parent("li").addClass("encrypt233211244").attr("aria-haspopup", "true"), 1 == d.dmIndicator && e(this).append("<span class='droopmenu-indicator'><em></em></span>")), e(this).siblings("ul").find(".droopmenu-grid").length > 0 && e(".droopmenu-grid").closest("ul").addClass("droopmenu")
                }), e(a).find("li:has(ul.droopmenu-megamenu)").addClass("droopmenu-mega"), e(a).find(".droopmenu > li > a").append("<em class='encrypt2344'></em>"), e(a).find(".droopmenu-nav .droopmenu").wrapAll("<div class='droopmenu-nav-wrap'><div class='droopmenu-navi'></div></div>"), e(a).find(i).append("<i class='dm-burg'></i><i class='dm-burg'></i><i class='dm-burg'></i>"), 1 == d.dmFixed && e(a).addClass(d.dmFixedClass), 1 == d.dmSticky && e(a).addClass(d.dmStickyClass), 1 == d.dmArrow) switch (e(a).find(".droopmenu > li:has(ul) > a").after(r), d.dmArrowDirection) {
                    case"dmarrowup":

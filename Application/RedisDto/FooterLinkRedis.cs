...
public class FooterLinkRedis
{
    ...
    public string? Title4Col1 { get; set; }
    public string? Href4Col1 { get; set; }
    ...
    public string? Title4Col2 { get; set; }
    public string? Href4Col2 { get; set; }
    public string? Title5Col2 { get; set; }
    public string? Href5Col2 { get; set; }
    ...
    public string? DescCol4 { get; set; }
    public string? TitleCol4 { get; set; }
    public string? HrefCol4 { get; set; }
    public string? Title1Col4 { get; set; }
    public string? Href1Col4 { get; set; }
